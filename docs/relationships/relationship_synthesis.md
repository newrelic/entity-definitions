...
| Event API              | Uses data generated by [New Relic events API](https://newrelic.com/instant-observability/event-api).                                                                                                                                                    |
...
| Network Monitoring      | Uses data generated by [Network Monitoring](https://docs.newrelic.com/docs/network-performance-monitoring/setup-performance-monitoring/network-flow-monitoring/).
