...
* The prefix "tags." doesn't to get specified as part of this structure, it still works independently and also takes a higher precedence over these prefixes. 
